...
def getEachColSumTkk():

	colSumArr = []

	for k in numTopics:
		for kPrime in numTopics:
...
WOrig, totalUVInfOrig = getUserUserInfluence("../centralFiles/userUserInfluenceFile.txt")
...
Qovk, totalVKQovk = getUserUserInfluence("../centralFiles/userTopicInfluenceFile.txt")
print("Got Orig topic topic influence matrix", len(Qovk), totalVKQovk)
