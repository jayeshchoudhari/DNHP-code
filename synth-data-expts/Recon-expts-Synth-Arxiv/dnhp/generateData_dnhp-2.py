			...
			for node in W[u]:
				...
				if kpresent != -1: 
					...
					for topic in Tau[parentTopic]:
						...
						WuvTaukk = W[u][node] * Tau[parentTopic][topic] * Qo[node][topic]
...
Qo = getUserUserInfluence(userTopicIntensityFileName)
print("Got User-Topic influence matrix", len(Qo))
