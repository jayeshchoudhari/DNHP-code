...
TauPred, totalKKInfPred = getUserUserInfluence("topicTopicInf.txt")
print("Got topic topic influence matrix", len(TauPred), totalKKInfPred)

effectiveWuvPred = getEffectiveWuvValue(WPred, totalKKInfPred)

WOrig, totalUVInfOrig = getUserUserInfluence("../centralFiles/userUserInfluence.txt")
print("Got Orig user-user influence matrix", len(WOrig), totalUVInfOrig)
